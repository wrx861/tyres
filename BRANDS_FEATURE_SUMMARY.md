...
```bash
# Получить бренды шин
curl "https://explore-repo.preview.emergentagent.com/api/products/brands/tires"

# Получить бренды дисков
curl "https://explore-repo.preview.emergentagent.com/api/products/brands/disks"
```
...
```bash
curl "https://explore-repo.preview.emergentagent.com/api/products/tires/search?diameter=15&brand=Michelin"
```

**Поиск дисков с фильтром по бренду:**
```bash
curl "https://explore-repo.preview.emergentagent.com/api/products/disks/search?diameter=16&brand=Replay"
```

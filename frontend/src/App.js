...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'search':
        return <SearchPage user={user} cart={cart} onAddToCart={addToCart} onBack={() => setCurrentPage('home')} />;
      case 'car-selection':
        return <CarSelectionPage user={user} cart={cart} onAddToCart={addToCart} onBack={() => setCurrentPage('home')} />;
      case 'cart':
        return (
          <CartPage 
            cart={cart}

      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <h1 className="text-xl font-bold dark:text-white">Админ-панель</h1>
          </div>
                      ...
                      <div key={order.order_id} className="bg-white rounded-xl p-6 shadow-sm">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold text-blue-600">{formatPrice(order.total_amount || order.total_price || 0)} ₽</p>
